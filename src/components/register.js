        ...
        <section className="fondo" style={sectionStyle}>
         ...
         <form class="col-12" method="get">
                    ...
                    <div class="col-12 forgot">
                        <a href="/main/login" className="b8"> ¿Tienes cuenta?</a>
                    </div>
                    <a href="/main/login">
                    
                    <button type="button" class="btn btn-danger btn-circle btn-xl"><svg width="10" height="20" viewBox="0 0 20 31" fill="none" xmlns="http://www.w3.org/2000/svg">
